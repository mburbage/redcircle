                                ...
                                <label style="cursor: pointer">
                                    ...
                                    <div class="whcom_panel_footer whcom_bg_white whcom_text_center">
                                        ...
                                        <span class="whcom_button whcom_button_block whcom_button_danger whcom_addon_remove_button"
                                              style="display: <?php echo ($dnsmanagement_checked) ? 'block' : 'none'; ?>">
                                        ...
                                        <span class="whcom_button whcom_button_block whcom_button_success whcom_addon_add_button"
                                              style="display: <?php echo ($dnsmanagement_checked) ? 'none' : 'block'; ?>">
                            ...
                            <div class="whcom_panel whcom_text_small whcom_op_addon_container whcom_bg_white">
                                <label style="cursor: pointer">
                                    ...
                                    <div class="whcom_panel_footer  whcom_bg_white whcom_text_center">
                                        ...
                                        <span class="whcom_button whcom_button_block whcom_button_danger whcom_addon_remove_button"
                                              style="display: <?php echo ($idprotection_checked) ? 'block' : 'none'; ?>">
                                            <i class="whcom_icon_basket-1"></i> <?php esc_html_e(" Added to Cart (Remove)", "whcom") ?>
                                        </span>
                                        <span class="whcom_button whcom_button_block whcom_button_success whcom_addon_add_button"
                                              style="display: <?php echo ($idprotection_checked) ? 'none' : 'block'; ?>">
                                            <i class="whcom_icon_plus"></i> <?php esc_html_e("Add to Cart", "whcom") ?>
                                        </span>
                                    </div>
                                </label>
                            ...
                            <div class="whcom_panel whcom_text_small whcom_op_addon_container whcom_bg_white">
                                <label style="cursor: pointer">
                                    ...
                                    <div class="whcom_panel_footer  whcom_bg_white whcom_text_center">
                                        ...
                                        <span class="whcom_button whcom_button_block whcom_button_danger whcom_addon_remove_button"
                                              style="display: <?php echo ($emailforwarding_checked) ? 'block' : 'none'; ?>">
											<i class="whcom_icon_basket-1"></i> <?php esc_html_e(" Added to Cart (Remove)", "whcom") ?>
										</span>
                                        <span class="whcom_button whcom_button_block whcom_button_success whcom_addon_add_button"
                                              style="display: <?php echo ($emailforwarding_checked) ? 'none' : 'block'; ?>">
											<i class="whcom_icon_plus"></i> <?php esc_html_e("Add to Cart", "whcom") ?>
										</span>
                                    </div>
                                </label>
                        ...
                        case '3':
                            {
                                ...
                                <div class="whcom_product_option whcom_form_field whcom_form_field_horizontal">
                                    ...
                                    <div class="whcom_checkbox_container">
                                        ...
                                        <label class="whcom_checkbox"
                                            ...
                                            <input name="configoptions<?php echo $index_append . '[' . $options_group['id'] . ']'; ?>"
                                                   value="1" id="configoption<?php echo $local_rand; ?>"
                                    ...
                                    <div class="loading_class"
                                         style="display: none; text-align: center; padding: 50px 0px 0px 0px;">
                                        Loading...
                                    </div>
                                </div>
                            <?php } ?>
        ...
        <div class="whcom_server_config">
            <div class="whcom_server_config_option whcom_form_field whcom_form_field_horizontal">
                ...
                <input type="text"
                       ...
                       class="whcom_op_input wcop_input"
                       id="inputHostname"
                       value=""
            ...
            <div class="whcom_form_field">
                    <div class="whcom_panel_body">
                        <label class="checkbox whcom_checkbox">
                            <input type="checkbox"
                                   name="accepttos"
                                   class="accepttos" <?php echo ($required_fields['accepttos']) ? '' : ''; ?>>
                            <?php esc_html_e("I have read and agree to the", "whcom") ?>
                            <a href="<?php echo $required_fields['tos_link']; ?>"
                               target="_blank"><u><?php esc_html_e("Terms of Service", "whcom") ?></u></a> </label>
                    </div>
    ...
    function whcom_op_render_estimate_taxes()
    {
        ...
        <form action="" method="post" class="whcom_op_promo_code_form">
            ...
            <div class="whcom_form_field whcom_form_field_horizontal">
                ...
                <input type="text" id="stateinput" value="<?php echo $_SESSION['whcom_tax_default_state']; ?>"
                       style="display: none;"
