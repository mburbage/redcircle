    ...
    public function view_edit_lfb() {
        ...
        <div class="modal fade" id="modal_removeAllSteps" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
                    ...
                    <div class="row-fluid" >
                        ...
                        <div class="form-group" >
                                ...
                                <small> ' . __('Enter a prefix for the order reference', 'lfb') . ' </small>
                                 <a href="javascript:" id="lfb_btnResetRef" onclick="lfb_resetReference();" data-toggle="tooltip" title="' . __('Reset the index to 0', 'lfb') . '"  class="btn btn-warning btn-circle"><span class="glyphicon glyphicon-refresh"></span></a>
                            ...
                            <div class="form-group" >
                                ...
                                <a href="https://support.google.com/analytics/answer/1032385?hl=en" target="_blank" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-info-sign"></span></a>
                            </div>
                            <div class="form-group" >
                                ...
                                <a href="https://developers.google.com/maps/documentation/javascript/get-api-key?hl=en" target="_blank" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-info-sign"></span></a>
                            </div>
           ...
           <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank"  class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
        </div>';
...
<h4> ' . __('Stripe payment', 'lfb') . ' </h4>             
           ...
           <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" style="margin-left: 8px;" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
        </div>';
            ...
            . '<a href="https://kb.mailchimp.com/accounts/management/about-api-keys" target="_blank" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-info-sign"></span></a>'
            . '</div>';
            echo '<div class="form-group">'
            ...
            . '<a href="https://support.getresponse.com/faq/where-i-find-api-key" target="_blank" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-info-sign"></span></a>'
            . '</div>';
            echo '<div class="form-group">'
            ...
            <a href="https://www.google.com/recaptcha/admin/create" target="_blank" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-info-sign"></span></a>
            </div>                         
            <div class="form-group">
    ...
    ';
            ...
            <div class="col-md-12" id="lfb_finalStepFields" >
                            <p ><a href="javascript:" id="lfb_addFieldBtn" onclick="lfb_editItem(0);" class="btn btn-primary" ><span class="glyphicon glyphicon-plus" ></span>' . __('Add a new Item', 'lfb') . ' </a></p>
 ...
 <div class="form-group " style="display:none;">
            ...
            echo '<div role="tabpanel" class="tab-pane" id="lfb_tabDesign" >
                    ...
                    <div class="col-md-4">
                                ...
                                <div class="form-group" >
                                   ...
                                   <a href="https://www.google.com/fonts" target="_blank"  data-toggle="tooltip" title="' . __('See Google fonts', 'lfb') . '" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-list"></span></a>
            ...
            echo'  <div class="form-group" >
                            ...
                            <div class="form-group" >';
            echo '<a href="javascript:" id="lfb_openFormDesignBtn" onclick="lfb_openFormDesigner();" class="btn btn-addon"><span class="fa fa-magic"></span>' . __('Form Designer', 'lfb') . '</a>';
                           ...
                           <label style="width: auto;">' . __('Allow users to manage their data ?', 'lfb') . '</label>
                            ...
                            <div id="alertCustomerData" class="alert alert-info">
                                ...
                                <p style="text-align: center;margin-top: 12px;">
                                   <a href="javascript:" onclick="lfb_editCustomerDataSettings();" class="btn btn-info"><span style="margin-right: 6px;" class="fas fa-font"></span>' . __('Edit global texts', 'lfb') . '</a>
                                </p>                            
                            </div>  
                        </div>
            ...
            echo '<div id="lfb_winShortcode" class="modal fade ">
                         <div class="modal-dialog">
                           <div class="modal-content">
                             <div class="modal-header">
                               <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                               <h4 class="modal-title">' . __('Generate a shortcode', 'lfb') . '</h4>
                             </div>
                             <div class="modal-body">';
            ...
            echo '<div id="lfb_winAskDeleteCustomer" class="modal fade">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">' . __('Delete this customer', 'lfb') . '</h4>
                              </div>
                              <div class="modal-body">
        ...
        <div class="modal fade" id="modal_editVariable" tabindex="-1" role="dialog"  aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
             <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">' . __('Edit a variable', 'lfb') . '</h4>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" id="modal_deleteVariable" tabindex="-1" role="dialog"  aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
             <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">' . __('Delete a variable', 'lfb') . '</h4>
              </div>
              <div class="modal-body">
            ...
            echo '<div id="lfb_winExportCustomersCsv" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">' . __('Download the customers list', 'lfb') . '</h4>
                      </div>
                      <div class="modal-body">
            ...
            echo '<div id="lfb_winCalendarCsv" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">' . __('Download the calendar events', 'lfb') . '</h4>
                      </div>
                      <div class="modal-body">
...
*/
    ...
    function loadLogs() {
        if (current_user_can('manage_options')) {
            ...
            $forms = $wpdb->get_results($wpdb->prepare("SELECT * FROM $table_nameF WHERE id=%s LIMIT 1", $formID));
    ...
    public function duplicateForm() {
        ...
        if (current_user_can('manage_options')) {
            ...
            foreach ($variables as $variable) {
                ...
                $wpdb->insert($table_redirections, (array) $variable);
            }
                    ...
                    if ($res === TRUE) {
                        ...
                        if (array_key_exists('forms', $dataJson)) {
                            foreach ($dataJson['forms'] as $key => $value) {
                                ...
                                if ($value['txtSignature'] == null || $value['txtSignature'] == '') {
    ...
    public function getWooProductsByTerm() {
        ...
        if (current_user_can('manage_options')) {
            ...
            if (is_plugin_active('woocommerce/woocommerce.php')) {
                ...
                $products = get_posts(array('post_type' => 'product', 'orderby' => 'category', 'order' => 'ASC', 'post__in' => $quote_ids, 'posts_per_page' => 60));
